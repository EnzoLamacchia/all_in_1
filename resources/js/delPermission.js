...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var azioni = document.getElementById('permissionTable');
    // console.log(azioni);
    ...
    azioni.addEventListener('click', function(ev) {
        ...
        if (actTo2 == 'delete') {
            ...
            let JSalert = new Promise(function (resolve, reject) {
                swal({
                        title: "CANCELLAZIONE!",
                        text: "Intendi eseguire la cancellazione del permesso?",
                        type: "warning",
                        showCancelButton: true,
                        //confirmButtonColor: "#DD6B55",
                        confirmButtonColor: "purple",
                        confirmButtonText: "SI, rimuovi permesso!",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            swal("Fatto!", "Il permesso è stato rimosso definitivamente!", "success");
                            eseguiCancellazione()
                        } else {
                            swal("No action!", "Il permesso non è stato rimosso!", "error");
                            return false;
                        }
                    });
            });
