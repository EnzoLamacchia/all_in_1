...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var tableDisponibili = document.getElementById('ruoliDisponibili');
    var tableAssegnati = document.getElementById('ruoliAssegnati');
            ...
            ajaxCall.onreadystatechange = function () {
                if (ajaxCall.readyState == 4 && ajaxCall.status == 200) {
                    ...
                    if (actTo2 == 'setruolo') {
                        ...
                        newAnewline.setAttribute ('action', 'delruolo');
                        ...
                        newAnewline.setAttribute ('action', 'setruolo');
