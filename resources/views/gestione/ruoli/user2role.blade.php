<x-gestione-layout>
    ...
    <div class="w-full bg-white px-6 py-8 rounded ">
        ...
        <x-header.subheader title="Assegnazione utenti al ruolo" urlCerca="" nomeBtnNuovo="" urlNuovo="">
        </x-header.subheader>
        ...
        <x-forms.setuser2role :ruolo="$ruolo" :usersWithout="$usersWithoutActualRole" :usersWithActualRole="$usersWithActualRole">
        </x-forms.setuser2role>
        </div>
    </div>
    @vite([
...
{{--    <script src="/js/setUser2Roles.js"></script>--}}
</x-gestione-layout>
