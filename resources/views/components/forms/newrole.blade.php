<main class="p-2 text-center">
    <div>
        <form class="bg-white p-3 rounded-lg shadow-lg w-full" method="POST" action="{{route('salvaruolo')}}">
            @csrf
            <div class="flex flex-row">
                <div class="w-1/2">
                    ...
                    <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"
                           type="text" name="name" id="name" placeholder="denominazione ruolo" value="{{old('name')}}"/>
                    @error('name')
