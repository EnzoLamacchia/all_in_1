<main class="p-2 text-center">
    <div>
        <form class="bg-white p-3 rounded-lg shadow-lg w-full" method="POST" action="{{route('salvautente')}}">
            @csrf
            <div class="flex flex-row">
                <div class="w-1/2">
                    ...
                    <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"
                           type="text" name="name" id="name" placeholder="nome" value="{{old('name')}}"/>
                    @error('name')
                ...
                <div class="w-1/2 pl-2">
                    ...
                    <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"
                           type="text" name="surname" id="surname" placeholder="cognome" value="{{old('surname')}}"/>
                    @error('surname')
                    <div class="text-red-500 text-left text-sm">{{ $message }}</div>
                    @enderror
                </div>
