        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <a href="{{ route('gespidieffe.censura') }}"
               class="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200
                ...
                <div class="flex items-center justify-center h-32 bg-gradient-to-br from-red-50 to-red-100
                            group-hover:from-red-100 group-hover:to-red-200 transition-all duration-200">
                    <svg class="w-14 h-14 text-red-500" fill="none" viewBox="0 0 24 24"
                ...
                <div class="p-5 flex-1">
                    <h3 class="text-base font-bold text-gray-900 mb-1">Censura PDF</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">
                        Oscura in modo permanente le parti sensibili del documento con rettangoli neri o bianchi.
                        Il testo censurato è irrecuperabile.
                    </p>
                </div>
                <div class="px-5 pb-4">
            ...
            <a href="{{ route('gespidieffe.merge') }}"
               class="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200
                ...
                <div class="flex items-center justify-center h-32 bg-gradient-to-br from-blue-50 to-blue-100
                            group-hover:from-blue-100 group-hover:to-blue-200 transition-all duration-200">
                    <svg class="w-14 h-14 text-blue-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" />
                    </svg>
                </div>
                <div class="p-5 flex-1">
                    <h3 class="text-base font-bold text-gray-900 mb-1">Merge PDF</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">
                        Unisci più file PDF in un unico documento, scegliendo l'ordine delle pagine.
                    </p>
                </div>
                <div class="px-5 pb-4">
            ...
            <a href="{{ route('gespidieffe.split') }}"
               class="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200
                ...
                <div class="flex items-center justify-center h-32 bg-gradient-to-br from-purple-50 to-purple-100
                            group-hover:from-purple-100 group-hover:to-purple-200 transition-all duration-200">
                    <svg class="w-14 h-14 text-purple-500" fill="none" viewBox="0 0 24 24"
                         stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-5 flex-1">
                    <h3 class="text-base font-bold text-gray-900 mb-1">Split PDF</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">
            ...
            <a href="{{ route('gespidieffe.organizza') }}"
               class="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200
                ...
                <div class="flex items-center justify-center h-32 bg-gradient-to-br from-yellow-50 to-yellow-100
                            group-hover:from-yellow-100 group-hover:to-yellow-200 transition-all duration-200">
                    <svg class="w-14 h-14 text-yellow-500" fill="none" viewBox="0 0 24 24"
                         stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-5 flex-1">
                    <h3 class="text-base font-bold text-gray-900 mb-1">Organizza pagine</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">
            ...
            <a href="{{ route('gespidieffe.ruota') }}"
               class="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200
                ...
                <div class="flex items-center justify-center h-32 bg-gradient-to-br from-green-50 to-green-100
                            group-hover:from-green-100 group-hover:to-green-200 transition-all duration-200">
                    <svg class="w-14 h-14 text-green-500" fill="none" viewBox="0 0 24 24"
                         stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-5 flex-1">
                    <h3 class="text-base font-bold text-gray-900 mb-1">Ruota pagine</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">
            ...
            <a href="{{ route('gespidieffe.numera') }}"
               class="group flex flex-col bg-white rounded-2xl shadow-sm border border-gray-200
                ...
                <div class="flex items-center justify-center h-32 bg-gradient-to-br from-indigo-50 to-indigo-100
                            group-hover:from-indigo-100 group-hover:to-indigo-200 transition-all duration-200">
                    <svg class="w-14 h-14 text-indigo-500" fill="none" viewBox="0 0 24 24"
                         stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-5 flex-1">
                    <h3 class="text-base font-bold text-gray-900 mb-1">Numera pagine</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">
                        Aggiungi numeri di pagina al documento: scegli formato, posizione e pagina iniziale.
